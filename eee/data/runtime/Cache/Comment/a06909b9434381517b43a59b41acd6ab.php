...
<head>
	...
	<link href="/eee/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
    <link href="/eee/public/simpleboot/css/simplebootadmin.css" rel="stylesheet">
    <link href="/eee/public/js/artDialog/skins/default.css" rel="stylesheet" />
    <link href="/eee/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
	...
	<!--[if IE 7]>
	<link rel="stylesheet" href="/eee/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
	<![endif]-->
...
<!-- Le javascript
    ...
    <script src="/eee/public/js/jquery.js"></script>
    <script src="/eee/public/js/wind.js"></script>
    <script src="/eee/public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
...
<body style="min-width: 800px;">
		...
		<form class="js-ajax-form" method="post">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($comments)): foreach($comments as $key=>$vo): ?><tr>
					...
					<td>
						<a target="_blank" href="/eee/<?php echo ($vo["url"]); ?>">查看原文</a> 
	...
	<script src="/eee/public/js/common.js"></script>
</body>
</html>