...
<div class="switch_page">
        <div class="navigation">
            ...
            <div class="specific_position" id="specific_position2">
                    <a href="<?php echo U('Home/Lib/index');?>" class="navigation_chart2" title="仪器使用预约"><span>>></span><p>仪器使用预约</p></a>
        ...
        <div class="position2">
            <h3>您的位置：实验室管理>>仪器使用预约</h3>
            <div class="order">
                <ul>
                    <li>
                    <span>开始日期：</span><input name="Fruit" type="text" value="" style="height:25px;width:155px;" /><select style="width:85px;color:#8e8e8e;height:31px;margin-left: 5px;">
                    ...
                    <li><span>实验仪器：</span><select style="width:250px;color:#8e8e8e;height:31px;">
                        <option value ="1">分光仪</option>
                    </select></li>
                    <li><span>仪器编号：</span><input name="Fruit" type="text" value="" style="height:25px;width:245px;" /><button class="inquiry">查询</button></li>
                    <li><span>用户备注：</span><textarea></textarea></li>
                    <li class="point_control"><button class="ordered">预约</button></li>
                </ul>
            </div>
            <img src="images/flow.jpg" height="308" width="308" style="float:right;margin: 20px 25px 0 0;">
        </div>
    </div>
	<div class="page_base">
